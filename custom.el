(custom-set-variables
 ...
 '(anything-grep-candidates-fast-directory-regexp "/dev/shm/")
 ...
 '(helm-c-adaptive-history-length 100)
...
* Sleep" :immediate-finish t :unnarrowed t))))
 ...
 '(safe-local-variable-values (quote ((outline-minor-mode) (eval add-hook (quote write-file-hooks) (quote time-stamp)) (ruby-compilation-executable . "ruby") (ruby-compilation-executable . "ruby1.8") (ruby-compilation-executable . "ruby1.9") (ruby-compilation-executable . "rbx") (ruby-compilation-executable . "jruby") (whitespace-line-column . 80) (lexical-binding . t))))
