(custom-set-variables
 ...
 '(LaTeX-mode-hook
   (quote
    (LaTeX-preview-setup flymake-mode-off turn-on-flyspell)))
 ...
 '(elpy-default-minor-modes (quote (eldoc-mode flycheck-mode auto-complete-mode)))
 ...
 '(erc-modules
   (quote
    (autoaway autojoin button completion fill irccontrols list log match menu move-to-prompt netsplit networks noncommands notify readonly ring services smiley stamp track truncate)))
 ...
 '(ido-minibuffer-setup-hook
   (quote
    ((lambda nil
       (local-set-key ""
                      (quote ido-prev-match)))
     (lambda nil
       (local-set-key ""
                      (quote ido-next-match))))))
...
")
 ...
 '(occur-mode-hook (quote (turn-on-font-lock turn-off-flyspell)))
