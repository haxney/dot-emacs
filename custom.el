...
\\doublespacing" ("%% %s" . "%% %s") ("%% %s" . "%% %s") ("%% %s" . "%% %s")))))
 ...
 '(sml/replacer-regexp-list (quote (("/gpfs/main/home/dhackney/" "~/") ("^~/\\.emacs\\.d/" ":ED:") ("^/sudo:.*:" ":SU:") ("^~/Documents/" ":Doc:") ("^~/Dropbox/" ":DB:") ("^:\\([^:]*\\):Documento?s/" ":\\1/Doc:") ("^~/[Gg]it/" ":Git:") ("^~/[Gg]it[Hh]ub/" ":Git:") ("^~/[Gg]it-?[Pp]rojects/" ":Git:") ("^~/work/classes/" ":Classes:") ("^~/work/railskating/" ":Rs:"))))
